    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-semibold tracking-tight text-slate-900">Refund Requests</h1>
                    <p className="text-sm text-slate-500">Review and respond to guest refund requests.</p>
                </div>
                                ...
                                <div className="flex flex-wrap items-start gap-3 justify-between">
                                    <div>
                                        <div className="flex items-center gap-2 flex-wrap">
                                            ...
                                            {req.reservation?.lodgifyReservationId && (
                                ...
                                {req.reservation?.amountPaid ? (
                                    <div className="mt-3 flex items-center gap-2 text-xs text-amber-700 bg-amber-50 border border-amber-100 rounded-lg px-3 py-2">
                                        ...
                                        <span>
                                            ...
                                            {' '} — issue the refund from the Reservations page after approving.
                                        </span>
                                    </div>
                                ) : null}
                                    ...
                                    <div className="mt-4 pt-4 border-t border-slate-100 flex flex-col md:flex-row gap-3 items-start md:items-center">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <button
                                                ...
                                                disabled={processingId === req.id}
                                                className="h-9 px-4 text-xs font-semibold rounded-lg bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50"
                                            >
